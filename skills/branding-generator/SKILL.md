...
Supports **text overlay** with configurable typography and layout rules. When generation is needed, prefer MPP image-gen endpoints (Tempo Wallet) before any scraping or custom adapters.
...
This skill includes 8 reference images under `references/` (originally generated as internal style anchors; study aesthetic logic, do not copy).
